...
class SalesGPT(Chain):
    ...
    salesperson_name: str = "Jackie"
    salesperson_role: str = "Sales lead"
    company_name: str = "Colaberry"
    company_business: str = "Colaberry offers specialized data analytics and data science programs that enable you to excel in the age of artificial intelligence leading to fulfilling, well-compensated jobs in the future workplace. Built on principles of inclusivity and empathy, Colaberry welcomes learners from various economic, racial, and occupational backgrounds."
    company_values: str = "At Colaberry, our mission is to empower underserved individuals amidst the challenges of workplace automation and unemployment. We provide proven career pathway solutions, focusing on the cultivation of essential tech and human skills."
    conversation_purpose: str = "find out whether they are looking to enroll into a data analytics or data science field."
